 ...
 * </p>
 */
public class BugFixedThrowableProxy implements Serializable {
    ...
    private static final BugFixedThrowableProxy[] EMPTY_THROWABLE_PROXY_ARRAY = new BugFixedThrowableProxy[0];
    ...
    private final BugFixedThrowableProxy causeProxy;
    ...
    private final BugFixedThrowableProxy[] suppressedProxies;
    ...
    private BugFixedThrowableProxy() {
        this.throwable = null;
        this.name = null;
     ...
     */
    public BugFixedThrowableProxy(final Throwable throwable) {
        this(throwable, null);
    }
     ...
     */
    private BugFixedThrowableProxy(final Throwable throwable, final Set<Throwable> visited) {
        ...
        this.causeProxy = throwableCause == null ? null : new BugFixedThrowableProxy(throwable, stack, map, throwableCause,
     ...
     */
    private BugFixedThrowableProxy(final Throwable parent, final Stack<Class<?>> stack, final Map<String, CacheEntry> map,
        ...
        this.causeProxy = causeCause == null || causeVisited.contains(causeCause) ? null : new BugFixedThrowableProxy(parent,
    ...
    public boolean equals(final Object obj) {
        ...
        final BugFixedThrowableProxy other = (BugFixedThrowableProxy) obj;
    ...
    private void formatCause(final StringBuilder sb, final String prefix, final BugFixedThrowableProxy cause,
    ...
    private void formatThrowableProxy(final StringBuilder sb, final String prefix, final String causeLabel,
                                      final BugFixedThrowableProxy throwableProxy, final List<String> ignorePackages,
    ...
    private void formatSuppressed(final StringBuilder sb, final String prefix, final BugFixedThrowableProxy[] suppressedProxies,
                                  final List<String> ignorePackages, final TextRenderer textRenderer, final String suffix) {
        if (suppressedProxies == null) {
            return;
        }
        for (final BugFixedThrowableProxy suppressedProxy : suppressedProxies) {
     ...
     * @param suffix
     */
    public void formatWrapper(final StringBuilder sb, final BugFixedThrowableProxy cause, final String suffix) {
    ...
    public void formatWrapper(final StringBuilder sb, final BugFixedThrowableProxy cause, final List<String> ignorePackages, final String suffix) {
     ...
     */
    @SuppressWarnings("ThrowableResultOfMethodCallIgnored")
    public void formatWrapper(final StringBuilder sb, final BugFixedThrowableProxy cause, final List<String> ignorePackages,
                              final TextRenderer textRenderer, final String suffix) {
    ...
    public BugFixedThrowableProxy getCauseProxy() {
     ...
     */
    public BugFixedThrowableProxy[] getSuppressedProxies() {
    ...
    public String getSuppressedStackTrace(final String suffix) {
        final BugFixedThrowableProxy[] suppressed = this.getSuppressedProxies();
        if (suppressed == null || suppressed.length == 0) {
            return Strings.EMPTY;
        }
        final StringBuilder sb = new StringBuilder("Suppressed Stack Trace Elements:").append(EOL);
        for (final BugFixedThrowableProxy proxy : suppressed) {
    ...
    private BugFixedThrowableProxy[] toSuppressedProxies(final Throwable thrown, Set<Throwable> suppressedVisited) {
        try {
            final Throwable[] suppressed = thrown.getSuppressed();
            if (suppressed == null) {
                return EMPTY_THROWABLE_PROXY_ARRAY;
            }
            final List<BugFixedThrowableProxy> proxies = new ArrayList<>(suppressed.length);
            ...
            for (int i = 0; i < suppressed.length; i++) {
                ...
                if (!suppressedVisited.contains(candidate)) {
                    ...
                    proxies.add(new BugFixedThrowableProxy(candidate, suppressedVisited));
                }
            }
            return proxies.toArray(new BugFixedThrowableProxy[proxies.size()]);
